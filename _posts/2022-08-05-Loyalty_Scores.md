...
loyalty_scores = pd.read_excel(r"C:\Users\kedei\Downloads\grocery_database(3).xlsx", sheet_name = 'loyalty_scores')
customer_details = d.read_excel(r"C:\Users\kedei\Downloads\grocery_database(3).xlsx", sheet_name = 'customer_details')
transactions = pd.read_excel(r"C:\Users\kedei\Downloads\grocery_database(3).xlsx", sheet_name = 'transactions')
